...
{
    public const int k_BezierMeasurement_Subdivisions = 2;
    ...
    public float Get_AccurateDistanceBetweenPoints(int _current, int _prev)
    {
        ...
        float measurementIncrement = 1f / k_BezierMeasurement_Subdivisions;
        float regionDistance = 0f;
        for (int i = 0; i < k_BezierMeasurement_Subdivisions - 1; i++)
        {
